...
const Dash = () => {
  ...
  return (
    <main className="self-center">
      <h2 className="m-6 mx-auto text-center text-6xl font-bold light:text-slate-400">
        Dashboard
      </h2>
      <div className="grid grid-cols-1 place-content-center gap-3 px-1 py-4 lg:grid-cols-2 lg:gap-4 lg:px-8 xl:grid-cols-3">
        <Link
          className="flex gap-2 rounded-lg bg-lightblue-100 p-6 text-base hover:bg-blue-950 hover:text-slate-100 light:bg-lightblue-950/40 lg:text-lg border border-blue-900 border border-blue-900"
          to={"./paper"}
        >
        ...
        <Link
          className="flex gap-2 rounded-lg bg-lightblue-100 p-6 text-base hover:bg-blue-950 hover:text-slate-100 light:bg-lightblue-950/40 lg:text-lg border border-blue-900 border border-blue-900 border border-blue-900"
          to={"./time_schedule"}
        >
