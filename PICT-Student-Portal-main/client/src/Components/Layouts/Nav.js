...
const Nav = () => {
  ...
  return (
    <nav
      id="nav"
      className="z-0 hidden h-full flex-col justify-stretch bg-slate-950 px-4 py-4 text-slate-100 light:bg-gradient-to-b light:from-slate-950 light:from-65% light:to-lightblue-950/60 light:to-95% lg:flex "
    >
      <ul className="m-auto flex flex-grow flex-col items-center justify-start gap-[6px]">
        <NavLink to={"./paper"} className="w-full font-medium">
          <li className="flex gap-2 rounded-md px-4 py-2 hover:bg-lightblue-600/40 ">
