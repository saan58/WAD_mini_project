...
const Soon = () => {
  return (
    <section className="w-full whitespace-break-spaces rounded-md bg-slate-400/50 p-4 text-justify hover:bg-slate-200 light:bg-slate-600/50 light:hover:bg-slate-800 lg:w-2/3 ">
