        ...
        <section className="pt-4">
          {paperList.map((paper, index) => (
            <Link to={paper.paper} key={index} onClick={() => setPaper(paper)}>
              <article className="mb-4 flex items-center whitespace-break-spaces rounded-md border-2 border-slate-900 bg-lightblue-200 p-2 hover:bg-lightblue-950 hover:text-slate-100 light:border-slate-200 light:bg-slate-950/5 light:hover:border-slate-200 light:hover:bg-slate-950/80 lg:p-4 ">
