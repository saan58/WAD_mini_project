  ...
  return (
    <main className="attendance">
      ...
      <section className="attendance__head">
        <form className="w-full gap-4 accent-lightblue-900 md:flex ">
          <div className="flex w-full flex-col">
            <label className="m-1" htmlFor="paper">
              Select Paper
            </label>
            <select
              className="mb-4 block h-10  rounded-md border-[1.5px] border-solid border-slate-400 p-1 pl-2 outline-none selection:border-slate-200 focus:border-lightblue-900 light:border-slate-200 light:caret-inherit light:focus:border-lightblue-400 light:active:border-lightblue-400 "
              name="paper"
              id="paper"
              value={paper}
              required
          ...
          <div className="flex w-full flex-col">
            ...
            <select
              className="mb-4 h-10 w-full rounded-md border-[1.5px] border-solid border-slate-400 p-1 pl-2 outline-none selection:border-slate-200 focus:border-lightblue-900 light:border-slate-200 light:caret-inherit light:focus:border-lightblue-400 light:active:border-lightblue-400"
              name="hour"
              id="hour"
              value={hour}
              required
          ...
          <div className="flex items-end">
            <button
              className=" mb-4 h-10 rounded-md border-[1.5px] border-solid border-lightblue-900 bg-slate-800 px-8 py-2 font-semibold tracking-wide text-slate-200 hover:bg-lightblue-900 focus:bg-lightblue-900 disabled:cursor-not-allowed light:border-lightblue-300 light:bg-lightblue-900 light:text-lightblue-100 light:hover:bg-slate-900 md:w-auto"
              type="submit"
        ...
        <form className="w-full">
          ...
          {attendance.length && disabled ? (
            <div className="flex gap-4">
              <button
                type="submit"
                className="mb-4 flex h-10 w-auto items-center gap-2 rounded-md border-[1.5px] border-solid border-lightblue-900 bg-slate-800 px-6 py-2 font-semibold tracking-wide text-slate-200 hover:bg-lightblue-900 focus:bg-lightblue-900 light:border-lightblue-300 light:bg-lightblue-900 light:text-lightblue-100 light:hover:bg-slate-900"
