    ...
    <main className="internal">
      ...
      <section className="form__head">
        <form className="w-full gap-4 accent-lightblue-900 md:flex">
          <select
            className="mb-4 block h-10 w-full rounded-md border-[1.5px] border-solid border-slate-400 p-1 pl-2 outline-none selection:border-slate-200 focus:border-lightblue-900 light:border-slate-200 light:caret-inherit light:focus:border-lightblue-400 light:active:border-lightblue-400 md:w-1/3"
                  ...
                  {internal?.map((student, index) => (
                    <tr
                      ...
                      className={
                        ...
                        7
                          ? "border-t-[1px] border-slate-400 bg-lightblue-900/50 first:border-none"
