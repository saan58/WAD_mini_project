                          ...
                          <td className="border-t-[1px] border-slate-400 p-0">
                            {!paper.joined ? (
                              <button
                                ...
                                className="m-0 flex h-auto w-full justify-center bg-transparent py-3  text-lg  hover:bg-lightblue-900 hover:text-slate-100 light:text-slate-100 "
                              >
                                Join
                              </button>
                            ) : (
                              <button
                                className="m-0 flex h-auto w-full justify-center bg-transparent py-3  text-lg  hover:bg-red-600 hover:text-slate-100 light:text-slate-100 "
                                type="button"
                                id={paper._id}
                                name={index}
